...
object Extraction {
  ...
  def fromRelnoun(inst: BinaryExtractionInstance[ChunkedToken], confidence: Double): Extraction = {
    ...
    val arg2s = Seq(ExtractionPartImpl(inst.extr.arg2.text, inst.extr.arg2.offsetInterval.start, inst.extr.arg2.tokenInterval))
  ...
  def fromSrlie(inst: SrlExtractionInstance, confidence: Double): Extraction = {
    ...
    val arg2s = inst.extr.arg2s.map { arg2 => ExtractionPartImpl(arg2.text, arg2.interval.start, arg2.tokenInterval) }
    ExtractionImpl(arg1, rel, arg2s, confidence)
  }
}