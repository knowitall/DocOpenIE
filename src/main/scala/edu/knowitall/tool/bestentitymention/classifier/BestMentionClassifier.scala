...
object BestMentionClassifier {
  ...
  val wekaBestMentionTrainer = new WekaLogisticTrainer(new BestMentionFeatures()) 
  val breezeBestMentionTrainer = new BreezeLogisticRegressionTrainer(new BestMentionFeatures())
